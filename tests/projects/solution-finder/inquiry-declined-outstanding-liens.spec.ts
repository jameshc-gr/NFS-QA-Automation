...
const inquiryConfig = {
  ...
  applicationInquiryInput: {
    ...
    basicInfoInput: {
      emailId: "retes-decline-heloan-11@yopmail.com",
      name: {
        first: "Erica",
        middle: "",
        last: "Lambert",
...
test(
  "@smoke NewInquiryPage - declined outstanding liens - HELOC ineligible HELOAN eligible",
  async ({ page }) => {
    ...
    // ──────────────────────────────────────────────────────────────────
    // Validate Offers UI (outstanding liens — HELOC ineligible, HELOAN eligible)
    // ──────────────────────────────────────────────────────────────────
    ...
    // HELOC offers (cards 0 and 1) are ineligible — outstanding liens exceed threshold
    for (const cardIndex of [0, 1]) {
      ...
      await expect(
        ...
        "The number of outstanding liens on the subject property exceeds our internal threshold",
      );
    }
