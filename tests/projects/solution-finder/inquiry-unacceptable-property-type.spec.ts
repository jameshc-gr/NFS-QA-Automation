...
const inquiryConfig = {
  ...
  applicationInquiryInput: {
    ...
    basicInfoInput: {
      emailId: "test-unexpected-property@yopmail.com",
      name: {
        first: "Erica",
        middle: "",
        last: "Lambert",
...
test(
  "@smoke NewInquiryPage - unacceptable property type - all offers ineligible",
  async ({ page }) => {
    ...
    // ──────────────────────────────────────────────────────────────────
    // Validate Offers UI (unacceptable property type — all offers ineligible)
    // ──────────────────────────────────────────────────────────────────
    ...
    // HELOC offers (cards 0 and 1) are ineligible — no AVM available for property
    ...
    // HELOAN (card 2) is ineligible — AVM-related failure (exact message varies in QA)
