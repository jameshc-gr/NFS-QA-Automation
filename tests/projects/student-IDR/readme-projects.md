...
The final execution-oriented case matrix, including profile data references and expected results, is maintained in [test-data/student-IDR/04_final_test_cases_with_data.csv](../../../test-data/student-IDR/04_final_test_cases_with_data.csv). The Jira-style execution report is [docs/student-IDR-test-execution-report-2026-07-27.md](../../../docs/student-IDR-test-execution-report-2026-07-27.md).
